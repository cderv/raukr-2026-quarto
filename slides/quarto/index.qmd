...
From the top folder of the exercises download:

``` r
source("00-check-setup.R", local = new.env())
```

Every line reads `[ok]`, and the last one is `>> All good. You are ready for Day 1.`
:::
...
::: notes
- **Do:** ~10 min. Ask for hands: who has every line `[ok]`?
