...
this cell: everything we write next assumes it.
:::
...
```
Export entries from Zotero, a DOI, or the journal's *Cite* button.
:::
::: {.column width="53%"}
...
**CSL** = *Citation Style Language*. Swap the `csl:` file to restyle everything for another journal.
:::
::::

. . .

The brackets decide how the citation reads:
...
::: notes
- **Say:** "The key is the only thing you type. The style file does the rest."
- **Ask:** "Who already keeps a `.bib` from Zotero?"
