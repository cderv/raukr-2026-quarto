...
this cell: everything we write next assumes it. Need a completed Part-1 report? Open
`authoring-checkpoint.qmd` in the same folder (the finished version of this document) and keep going.
:::
...
make it a **branded, citable article**, add two things:
...
::: {.callout-note title="Follow along"}
Back in your editor: add citations to your Part-1 document (or to `authoring-checkpoint.qmd`).
:::
...
your own Part-1 file (or the completed `authoring-checkpoint.qmd`), then render it as a **branded Typst PDF**. You'll
finish with a **branded, citable PDF** ready for further publication work.
:::
