...
::: notes
- **Say:** "You know R Markdown or Quarto. Today we take one `.qmd` from source to a citable,
  branded PDF."
:::
...
- **If asked:** cells select the engine: `{r}` uses knitr; `{python}` uses Jupyter.
...
::: notes
- **Say:** "Authoring Challenge: 45 minutes. We meet again at 15:30. Ask us if you get stuck."
...
::: notes
- **Say:** "Citations Challenge: add the bibliography and render a branded Typst PDF. You have 30 minutes."
- **Watch for:** exact citation key; first font download; PDF lands beside its source.
:::
