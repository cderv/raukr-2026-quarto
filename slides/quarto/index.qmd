...
your **`my-report.qmd`** (save `authoring-checkpoint.qmd` as `my-report.qmd` if you did not finish Part 1), then render
it as a **branded Typst PDF**. You'll finish with a **branded, citable PDF** ready for further publication work.
:::
