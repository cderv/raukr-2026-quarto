...
- **Do:** show *File > Open Folder...* on `day1-intro/`. Positron has no `.Rproj`, the folder is the project.
- **Do:** right-click a folder in the Explorer > **Set as Working Directory in Active Console**, for anyone whose console points elsewhere.
